...
public class HomeWorkFigure {

	public int length;
	public int width;
	public int perimetr;
	
	public HomeWorkFigure (String type) {
...
//		perimetr = width * length;
	...
	public static void main (String args[]) {
		...
		HomeWorkFigure rectangle = new HomeWorkFigure("Rectangle");
		HomeWorkFigure square = new HomeWorkFigure("Square");
