...
public class DBUtils implements IExternalData {
	private final String SQL_NOT_FOUND_EXCEPTION= "SQL Exception found";
	//
...
//	private String url = "jdbc:jtds:sqlserver://CLASS86/NewUsers;instance=SQLEXPRESS2;";
	...
	public List<List<String>> getAllCells(String connection) {
		...
		try {
			...
			throw new GeneralRegresException(SQL_NOT_FOUND_EXCEPTION, e);
		}
		...
		try {
			...
			//rs = st.executeQuery("select Firstname, Lastname, Email, Login, Password, Community from newusers;");
